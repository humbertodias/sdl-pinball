...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/cex/dev/repository/personal/sdl-pinball/Pinball/build/Box2D-prefix/src/Box2D'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/cex/dev/repository/personal/sdl-pinball/Pinball/build/Box2D-prefix/src/Box2D'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
